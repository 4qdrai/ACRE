...
This connects directly to the **SIGReg regularization** from ALPS/ALPS-4B (Bardes et al., 2024; Klindt et al., 2026), which provides a principled framework for controlling representation collapse while maintaining contraction properties.
